...
<?php 
    ...
    $nc=$_REQUEST['nc'];
    $consulta="select * from productodos where id_productodos='".$nc."'";
...
<body> 
  ...
  <div data-role="header">
    <a href="lcolor.php" data-role="button" data-icon="home" data-iconpos="notext" data-theme="b" data-iconpos="left" data-inline="true">Inicio</a>
...
<div data-role="content" data-theme="c">
        <form name="formreg" action="actualizar.php" method="POST">
          ...
          <input type="text" name="numero" id="basic" value="<?php echo $numero;?>" required />
          <label for="basic">Existencia:</label>
          <input type="text" name="existencia" id="basic" value="<?php echo $existencia;?>" required />
