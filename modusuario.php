...
<?php 
    ...
    $nc=$_REQUEST['nc'];
    $consulta="select * from usuarios where id_usuario='".$nc."'";
...
<div data-role="content" data-theme="c">
        <form name="formreg" action="actualizar.php" method="POST">
          ...
          <input type="text" name="usuario" id="basic" value="<?php echo $usuario;?>" required />
          <label for="basic">Password:</label>
          <input type="password" name="password" id="basic" value="<?php echo $password;?>" required />
          
      <input type="submit" name="envio" value="Actualizar" data-theme="b"/>
      <input type="hidden" name="fn" value="15" /> 
      </form>
