...
<?php 
    ...
    $nc=$_REQUEST['nc'];
    $consulta="select * from empleados where id_empleados='".$nc."'";
...
<div data-role="content" data-theme="c">
      <form name="formreg" action="actualizar.php" method="POST">
          ...
          <input type="text" name="telefono" id="basic" value="<?php echo $telefono;?>"  />
          ...
          <label for="basic">Puesto:</label>
          <input type="text" name="puesto" id="basic" value="<?php echo $puesto;?>"  />
