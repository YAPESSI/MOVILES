...
<body>
     ...
     <div data-role="page" class="type-interior" id="album-list">
          ...
          <a href="index2.php#menu" data-icon="home" data-iconpos="notext" data-direction="reverse">Home</a>
	   	<a href="lcolor.php" data-icon="search" data-iconpos="notext" data-rel="dialog" data-transition="fade">Search</a>		
	   	</div><!--/header-->
	   	...
	   	?>
	   	   ...
	   	   <li><?php echo '<a href="modmodelo.php?nc='.$row["id_modelo"].'">';?>
	   	      <img src="<?php if($row["foto"]==NULL){echo 'images/kate.jpg';}
	   	      else {echo 'mostrarfoto.php?nc='.$row["id_modelo"];}?>" width="50" heigth="55"/>
	   	      <h3><?php echo $row["nom_modelo"];?></h3>
	   	      <p><?php echo $row["nom_modelo"];?></p>
	   	      </a>
	   	      <a ref="#purchase" data-rel="popup" data-position-to="window"
	   	      data-transition="pop"><?php echo $row["nom_modelo"]?></a>
	   	      </li>
