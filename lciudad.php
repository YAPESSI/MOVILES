     ...
     <div data-role="page" class="type-interior" id="album-list">
	    ...
	    <a href="lciudad.php" data-icon="search" data-iconpos="notext" data-rel="dialog" data-transition="fade">Search</a>		
	   	...
	   	?>
	   	   ...
	   	   <li><?php echo '<a href="modalciudad.php?nc='.$row["id_ciudad"].'">';?>
	   	      <img src="<?php if($row["foto"]==NULL){echo 'images/kate.jpg';}
	   	      else {echo 'mostrarfoto.php?nc='.$row["id_ciudad"];}?>" width="50" heigth="55"/>
	   	      <h3><?php echo $row["nombre_ciudad"];?></h3>
	   	      <p><?php echo $row["nombre_ciudad"];?></p>
	   	      </a>
	   	      <a ref="#purchase" data-rel="popup" data-position-to="window"
	   	      data-transition="pop"><?php echo $row["nombre_ciudad"]?></a>
	   	      </li>
	   	      <?php } ?>
	   	      </ul>
