...
<?php 
    ...
    $nc=$_REQUEST['nc'];
    $consulta="select * from modelo where id_modelo='".$nc."'";
    $recordset=mysql_query($consulta);
    $row=mysql_fetch_array($recordset);
    $nom_modelo=$row["nom_modelo"];
...
<body> 
  ...
  <div data-role="header">
    <a href="lmodelo.php" data-role="button" data-icon="home" data-iconpos="notext" data-theme="b" data-iconpos="left" data-inline="true">Inicio</a>
...
<div data-role="content" data-theme="c">
      ...
      <label for="basic">Nombre modelo:</label>
      <input type="text" name="nom_modelo" id="basic" value="<?php echo $nom_modelo;?>" required />
