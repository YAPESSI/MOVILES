...
<body>
     ...
     <div data-role="page" class="type-interior" id="album-list">
          ...
          <a href="index2.php#menu" data-icon="home" data-iconpos="notext" data-direction="reverse">Home</a>
	   	<a href="lclientes.php" data-icon="search" data-iconpos="notext" data-rel="dialog" data-transition="fade">Search</a>		
	   	</div><!--/header-->
	   	...
	   	?>
	   	   ...
	   	   <li><?php echo '<a href="modcolonia.php?nc='.$row["id_colonia"].'">';?>
	   	      <img src="<?php if($row["foto"]==NULL){echo 'images/kate.jpg';}
	   	      else {echo 'mostrarfoto.php?nc='.$row["id_colonia"];}?>" width="50" heigth="55"/>
	   	      <h3><?php echo $row["nombre_colonia"];?></h3>
	   	      <p><?php echo $row["nombre_colonia"];?></p>
	   	      </a>
	   	      <a ref="#purchase" data-rel="popup" data-position-to="window"
	   	      data-transition="pop"><?php echo $row["nombre_colonia"]?></a>
	   	      </li>
